    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(autho -> autho
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/biblioteca/deleteLivros").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/biblioteca/updateLivros").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/biblioteca/privado").hasRole("ADMIN")
